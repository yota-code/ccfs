...
then
	echo "first load the compilation environment"
fi

ccfs_standard_install.sh openssl-3.3.2
...
ccfs_standard_install.sh Python-3.13.0
ccfs_standard_install.sh zsh-5.9
ccfs_standard_install.sh git-2.47.0
